...
The computational cycle of the PIC method is shown in Figure \ref{3.1.4}. Individual steps are closer described in several following sections. The influence of the choice of the time and spatial step on the stability and accuracy of the PIC method will be demonstrated as well. An extensive study of PIC method can be found in \cite{birdsall, hockney}. The particle-in-cell EPOCH \cite{bennett}, which has been used for the simulations within this work, is described in the last section of this chapter.