...
\begin{figure}[h!]
	\centering
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/parax/ey_focus.pdf}}}
	\hspace{1mm}
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/parax/ex_focus.pdf}}}\\
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/lbcs/ey_focus.pdf}}}
	\hspace{1mm}
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/lbcs/ex_focus.pdf}}}
...
\begin{figure}[h!]
	\centering
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/parax/Ey_focus_5mic.pdf}}}
	\hspace{1mm}
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/parax/Ex_focus_5mic.pdf}}}\\
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/lbcs/Ey_focus_5mic.pdf}}}
	\hspace{1mm}
	\sidesubfloat[]{{\includegraphics[width=0.415\linewidth]{./img/lbcs/Ex_focus_5mic.pdf}}}
