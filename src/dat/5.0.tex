...
\end{equation}
Wave equation for E (analogically for B):
\begin{equation}
...
\begin{equation}
\left(\frac{\omega^2}{c^2} - k^2_x - k^2_y \right) \bar{\vec{E}} \left(k_x, k_y, z, \omega \right) + \diffp[2]{}{z} \bar{\vec{E}} \left(k_x, k_y, z, \omega \right) = 0.
\end{equation}
after subs:
\begin{equation}
