...
\begin{equation}
\div{\vec{E}\left( \vec{r}, t \right)} = \frac{\rho\left( \vec{r}, t \right)}{\varepsilon_0}
\end{equation}
\begin{equation}
\div{\vec{B}\left( \vec{r}, t \right)} = 0
\end{equation}
\begin{equation}
\rot{\vec{E}\left( \vec{r}, t \right)} = - \diffp{\vec{B}\left( \vec{r}, t \right)}{t}
\end{equation}
\begin{equation}
\rot{\vec{B}\left( \vec{r}, t \right)} = \mu_0 \vec{J}\left( \vec{r}, t \right) + \varepsilon_0 \mu_0 \diffp{\vec{E}\left( \vec{r}, t \right)}{t}
\end{equation}
Macroscopic Maxwell's equations:
\begin{equation}
\div{\vec{D}\left( \vec{r}, t \right)} = \rho\left( \vec{r}, t \right)
\end{equation}
\begin{equation}
\div{\vec{B}\left( \vec{r}, t \right)} = 0
\end{equation}
...
\end{equation}
\begin{equation}
\rot{\vec{H}\left( \vec{r}, t \right)} = \vec{J}\left( \vec{r}, t \right) + \diffp{\vec{D}\left( \vec{r}, t \right)}{t}
\end{equation}
where:
\begin{equation}
\vec{D}\left( \vec{r}, t \right) = \varepsilon_0 \vec{E}\left( \vec{r}, t \right) + \vec{P}\left( \vec{r}, t \right) = \varepsilon \vec{E}\left( \vec{r}, t \right)
\end{equation}
\begin{equation}
\vec{B}\left(\vec{r}, t \right) = \mu_0 \vec{H}\left( \vec{r}, t \right) + \vec{M}\left( \vec{r}, t \right) = \mu \vec{H}\left(\vec{r}, t \right)
\end{equation}
potentials:
\begin{equation}
\vec{B}\left( \vec{r}, t \right) = \rot{\vec{A}\left( \vec{r}, t \right)}
\end{equation}
\begin{equation}
\vec{E}\left( \vec{r}, t \right) = -\grad{\phi \left( \vec{r}, t \right)} - \diffp{\vec{A}\left( \vec{r}, t \right)}{t}
\end{equation}
Maxwell's equations (wave equations) in terms of potentials:
\begin{equation}
-\laplace{\phi\left( \vec{r}, t \right)} - \diffp{}{t} \left(\div{\vec{A}\left( \vec{r}, t \right)} \right) =  \frac{\rho\left( \vec{r}, t \right)}{\varepsilon_0}
\end{equation}
\begin{equation}
\left(-\laplace{} + \frac{1}{c^{2}} \diffp[2]{}{t} \right) \vec{A}\left( \vec{r}, t \right) + \grad{\left( \div{\vec{A}\left( \vec{r}, t \right) + \frac{1}{c^{2}}\diffp{\phi\left( \vec{r}, t \right)}{t}} \right)} = \mu_0 \vec{J}\left( \vec{r}, t \right)
\end{equation}
Lorenz gauge:
\begin{equation}
\div{\vec{A}\left( \vec{r}, t \right)} + \frac{1}{c^{2}} \diffp{\phi\left( \vec{r}, t \right)}{t} = 0
\end{equation}
then:
\begin{equation}
\left(-\laplace{} + \frac{1}{c^{2}} \diffp[2]{}{t} \right)\phi\left( \vec{r}, t \right) = \dalembert{\phi\left( \vec{r}, t \right)} = \frac{\rho\left( \vec{r}, t \right)}{\varepsilon_0}
\end{equation}
\begin{equation}
\left(-\laplace{} + \frac{1}{c^{2}} \diffp[2]{}{t} \right)\vec{A}\left( \vec{r}, t \right) = \dalembert{\vec{A}\left( \vec{r}, t \right)} = \mu_0 \vec{J} \left( \vec{r}, t \right)
\end{equation}
continuity equation (conservation of charge):
\begin{equation}
\div{\vec{J}\left( \vec{r}, t \right)} + \diffp{\rho\left( \vec{r}, t \right)}{t} = 0
\end{equation}
Lorentz force:
\begin{equation}
\vec{F}\left( \vec{r}, t \right) = q \left(E\left( \vec{r}, t \right) + v\left( \vec{r}, t \right) \times B\left( \vec{r}, t \right) \right) 
\end{equation}
Ohm's law:
\begin{equation}
\vec{J}\left( \vec{r}, t \right) = \sigma \vec{E}\left( \vec{r}, t \right)
\end{equation}
\newpage
wave equation for $ \vec{E} $ field:
\begin{equation*}
\laplace{\vec{E}} - \frac{1}{c^2}\diffp[2]{\vec{E}}{t} = 0
\end{equation*}
$ \vec{E} $ in the form of plane wave propagating along z-axis:
\begin{equation*}
\vec{E}\left(x, y, z, t\right)  = \vec{E_0}\left(x, y, z\right) \e^{i(k_z z - \omega t)}
\end{equation*}
Helmholtz equation:
\begin{equation*}
\laplace{\vec{E_0}} + 2 \i k_z \diffp{\vec{E_0}}{z} = 0
\end{equation*}
