...
The fig. \ref{fig:13} demonstrates the angular distribution of electrons in the whole simulation domain at the time $ t = 100 \ \mathrm{fs} $ where one can see in more details. For low-energy electrons, the angular distribution is almost isotropic. 0.5 micron more collimated for laser intensity 1e20, 2.0 micron more collimated for intensity 1e21. 
