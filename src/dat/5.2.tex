...
For the laser beam with constant energy, the peak laser intensity grows with the decreasing focal spot size. As can be seen from the table \ref{table:3}, the interactions consequently result in increasing the hot electron temperature and maximum ion energy. The comparison of absorption rates for the laser beam with constant energy strongly depends on the laser intensity at focus. Therefore, to better understand the dependency of energy absorption on the size of the focal spot, it is better to study the results of laser-matter interaction for the laser beams with constant intensities.
