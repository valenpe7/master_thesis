...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.385\paperwidth]{./img/YEE/yee.eps}
...
\end{equation}
It means that it is possible to solve only equations \ref{3.1.1.16} and \ref{3.1.1.7}, while the divergence equations \ref{3.1.1.6}, \ref{3.1.1.15} can be considered as the initial conditions. In this case, the continuity equation in the finite differences (\ref{3.1.1.13}) has to be fulfilled.