This part contains input files of several most important simulations that have been performed for the purposes within this work.  
...
\begin{lstlisting}[style=CXX, caption=test paraxial]
begin:control
	nx = 1600
	ny = 4800
	x_min = -8 * micron
...
\begin{lstlisting}[style=CXX, caption=2kppc]
begin:control
	nx = 1875
	ny = 5000
	x_min = 0 * micron
